      ...
      <Card className="relative overflow-hidden border border-gray-200 border-neutral-800/50 bg-black/20 backdrop-blur-sm dark:border-gray-800">
        <div className="relative space-y-4 p-6">
            ...
            <div className="flex items-center gap-4">
              {credibilityScore ? (
                <div className="flex items-center gap-2">
                  <span className="font-mono text-xs text-neutral-500">σ = {credibilityScore.toFixed(2)}</span>
                </div>
              ) : (
          ...
          <div className="space-y-2">
            <h3 className="font-mono text-lg font-bold tracking-tight text-neutral-200">{title}</h3>
            ...
            <div className="flex items-center gap-2">
              {sourceVerified ? (
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs text-neutral-500">Source Verified</span>
                </div>
              ) : (
                <div className="flex items-center gap-2">
                  <VerificationProgress />
                  <span className="font-mono text-xs text-neutral-500">Verifying</span>
                </div>
              )}
            </div>
            <time className="font-mono text-xs text-neutral-500">{timestamp}</time>
          </div>
        </div>
