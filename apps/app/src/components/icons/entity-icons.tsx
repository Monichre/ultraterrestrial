...
export const LightingBolt = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M11.25 11.25C11.25 12.3546 10.3546 13.25 9.25 13.25H6.75C5.64543 13.25 4.75 12.3546 4.75 11.25V9.06349C4.75 8.2262 5.09991 7.427 5.71516 6.85908L8 4.75V7.75H9.25C10.3546 7.75 11.25 8.64543 11.25 9.75V11.25Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M19.25 17.25C19.25 18.3546 18.3546 19.25 17.25 19.25H14.75C13.6454 19.25 12.75 18.3546 12.75 17.25V15.0635C12.75 14.2262 13.0999 13.427 13.7152 12.8591L16 10.75V13.75H17.25C18.3546 13.75 19.25 14.6454 19.25 15.75V17.25Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
    </svg>
  )
}
...
export const ArtifactsIcon = ( { stroke = ICON_GREEN, fill, onClick }: IconProps ) => {
  return (
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><motion.path initial={{ pathLength: 0.001 }}
      animate={{ pathLength: 1 }}
      transition={transition} d="M12.3536 13.3536C12.1583 13.5488 11.8417 13.5488 11.6465 13.3536L6.39645 8.10355C6.36478 8.07188 6.33824 8.03702 6.31685 8H5.00002C4.78719 8 4.59769 7.86528 4.52777 7.66426L2.12777 0.764277C2.05268 0.548387 2.13355 0.309061 2.3242 0.182972C2.51486 0.0568819 2.76674 0.0761337 2.93602 0.229734L8.336 5.12972C8.44044 5.22449 8.50001 5.35897 8.50001 5.5V5.81684C8.53702 5.83824 8.57189 5.86478 8.60356 5.89645L13.8536 11.1464C14.0488 11.3417 14.0488 11.6583 13.8536 11.8536L12.3536 13.3536ZM8.25 6.95711L7.45711 7.75L12 12.2929L12.7929 11.5L8.25 6.95711ZM3.71669 2.28845L5.35549 7H6.2929L7.50001 5.79289V5.72146L3.71669 2.28845Z" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"></motion.path></svg>
  )
}
...
export const TelescopeIcon = ( {
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M8.67641 12.3872L9.15839 13.3564C9.40399 13.8502 10.003 14.0519 10.4973 13.8073L11 13.5585M8.67641 12.3872L8.14195 11.3126C7.91787 10.862 8.0635 10.3151 8.48199 10.0357L16.3972 4.75L19.25 9.47551L11 13.5585M8.67641 12.3872L4.75 14.25M11 13.5585L7.75 19.25M11 13.5585L14.25 19.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
    </svg>
  )
}

export const MagicWandIcon = ( { stroke = ICON_GREEN, fill, onClick }: IconProps ) => {
  return (
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={onClick}  >
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M13.9 0.499976C13.9 0.279062 13.7209 0.0999756 13.5 0.0999756C13.2791 0.0999756 13.1 0.279062 13.1 0.499976V1.09998H12.5C12.2791 1.09998 12.1 1.27906 12.1 1.49998C12.1 1.72089 12.2791 1.89998 12.5 1.89998H13.1V2.49998C13.1 2.72089 13.2791 2.89998 13.5 2.89998C13.7209 2.89998 13.9 2.72089 13.9 2.49998V1.89998H14.5C14.7209 1.89998 14.9 1.72089 14.9 1.49998C14.9 1.27906 14.7209 1.09998 14.5 1.09998H13.9V0.499976ZM11.8536 3.14642C12.0488 3.34168 12.0488 3.65826 11.8536 3.85353L10.8536 4.85353C10.6583 5.04879 10.3417 5.04879 10.1465 4.85353C9.9512 4.65827 9.9512 4.34169 10.1465 4.14642L11.1464 3.14643C11.3417 2.95116 11.6583 2.95116 11.8536 3.14642ZM9.85357 5.14642C10.0488 5.34168 10.0488 5.65827 9.85357 5.85353L2.85355 12.8535C2.65829 13.0488 2.34171 13.0488 2.14645 12.8535C1.95118 12.6583 1.95118 12.3417 2.14645 12.1464L9.14646 5.14642C9.34172 4.95116 9.65831 4.95116 9.85357 5.14642ZM13.5 5.09998C13.7209 5.09998 13.9 5.27906 13.9 5.49998V6.09998H14.5C14.7209 6.09998 14.9 6.27906 14.9 6.49998C14.9 6.72089 14.7209 6.89998 14.5 6.89998H13.9V7.49998C13.9 7.72089 13.7209 7.89998 13.5 7.89998C13.2791 7.89998 13.1 7.72089 13.1 7.49998V6.89998H12.5C12.2791 6.89998 12.1 6.72089 12.1 6.49998C12.1 6.27906 12.2791 6.09998 12.5 6.09998H13.1V5.49998C13.1 5.27906 13.2791 5.09998 13.5 5.09998ZM8.90002 0.499976C8.90002 0.279062 8.72093 0.0999756 8.50002 0.0999756C8.2791 0.0999756 8.10002 0.279062 8.10002 0.499976V1.09998H7.50002C7.2791 1.09998 7.10002 1.27906 7.10002 1.49998C7.10002 1.72089 7.2791 1.89998 7.50002 1.89998H8.10002V2.49998C8.10002 2.72089 8.2791 2.89998 8.50002 2.89998C8.72093 2.89998 8.90002 2.72089 8.90002 2.49998V1.89998H9.50002C9.72093 1.89998 9.90002 1.72089 9.90002 1.49998C9.90002 1.27906 9.72093 1.09998 9.50002 1.09998H8.90002V0.499976Z" fill={fill} fill-rule="evenodd" clip-rule="evenodd"></motion.path></svg>
  )
}


export const AlienIcon = ( { stroke = ICON_GREEN, fill = 'none', className }: IconProps ) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M7.53601 16.0616C8.01848 16.559 8.53188 17.0319 9.01987 17.524C9.74801 18.2582 10.9297 19.25 12 19.25C13.0703 19.25 14.252 18.2582 14.9801 17.524C15.4681 17.0319 15.9815 16.559 16.464 16.0616C20.266 12.1412 17.6339 4.75 12 4.75C6.36613 4.75 3.734 12.1412 7.53601 16.0616Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M10.25 12.25L8.75 10.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M13.75 12.25L15.25 10.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
    </svg>
  )
}

export const FlyingSaucerIcon = ( { stroke = ICON_GREEN, fill = 'none', className }: IconProps ) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M8.75 15.75L6.75 19.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M15.25 15.75L17.25 19.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M15.25 8.75H8.75C7.09315 8.75 5.75 10.0931 5.75 11.75V12.25H18.25V11.75C18.25 10.0931 16.9069 8.75 15.25 8.75Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M7.75 8.75C7.75 6.40279 9.65279 4.75 12 4.75C14.3472 4.75 16.25 6.40279 16.25 8.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
    </svg>
  )
}

export const UFOIcon = ( { stroke = ICON_GREEN, fill = 'none', className }: IconProps ) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M6.85467 10.408C5.34979 11.5973 4.52773 12.9733 4.80246 14.1495C5.27992 16.1938 8.88944 16.8604 12.8645 15.6385C16.8396 14.4166 19.675 11.7688 19.1975 9.7246C18.9572 8.6957 17.9235 8.01578 16.449 7.75L15.9492 7.66016" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M16.75 17.75L18.25 19.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M13.75 18.75L14.25 19.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M18.75 15.75L19.25 16.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M10.5003 4.90074L9.97512 5.04283C7.65461 5.67062 6.27752 8.07889 6.8993 10.4218L7.04259 10.9618C7.2165 11.6171 7.71414 12.1392 8.38877 12.2068C9.22364 12.2906 10.5035 12.2886 12.0672 11.8655C13.6387 11.4404 14.7514 10.7916 15.4321 10.2967C15.9766 9.90072 16.146 9.20539 15.9733 8.55469L15.8278 8.00632C15.206 5.66336 12.8208 4.27295 10.5003 4.90074Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
    </svg>
  )
}
...
export const SlashIcon = ( { stroke = ICON_GREEN, fill = ICON_GREEN, onClick }: IconProps ) => {
  return (
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={onClick}>
      <motion.path
        initial={{ pathLength: 0.001 }}
...
export const OracleIcon = ( { stroke = ICON_GREEN, fill = ICON_GREEN, onClick, className }: IconProps ) => {
  return (
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={onClick} className={className}>
      <motion.path
        initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition}
