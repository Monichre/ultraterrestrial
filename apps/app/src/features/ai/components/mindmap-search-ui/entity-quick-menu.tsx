...
const menuCategories = [
  { label: 'Events', slug: 'events', menuWidth: 320, menuHeight: 240 },
  {
    label: 'Topics',
    slug: 'topics',
    menuWidth: 600,
...
export function EntityQuickMenu() {
  ...
  return (
    <motion.div
      animate={{
        height: isOpen ? 500 : 52,
        width: isOpen ? 600 : 'auto',
      }}
      transition={{
        type: 'spring',
        duration: 0.6,
    ...
    >
      <div className='h-full'>
        ...
        >
          ...
          {isOpen && subMenuSelected === 'testimonies' && (
            <motion.div
              initial={{ opacity: 0, filter: 'blur(4px)' }}
              animate={{ opacity: 1, filter: 'blur(0px)' }}
              transition={{ duration: 1.2, type: 'spring' }}
          ...
          {isOpen && subMenuSelected === 'organizations' && (
            <motion.div
              initial={{ opacity: 0, filter: 'blur(4px)' }}
              animate={{ opacity: 1, filter: 'blur(0px)' }}
              transition={{ duration: 1.2, type: 'spring' }}
