...
export const RESEARCH_TO_DATABASE_SCHEMA_V1_PROMPT = `
...
IMPORTANT:Your responses should always be well-organized and ready to be inserted into this database structure.

# Core Knowledge Structure

## Main Entities You Track
