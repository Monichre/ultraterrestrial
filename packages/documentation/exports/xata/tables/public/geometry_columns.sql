...
grant delete, insert, references, select, trigger, truncate, update on geometry_columns to postgres;

grant delete, insert, references, select, trigger, truncate, update on geometry_columns to anon;

grant delete, insert, references, select, trigger, truncate, update on geometry_columns to authenticated;

grant delete, insert, references, select, trigger, truncate, update on geometry_columns to service_role;
