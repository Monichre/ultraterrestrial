...
alter function postgis_full_version() owner to supabase_admin;

grant execute on function postgis_full_version() to postgres;

grant execute on function postgis_full_version() to anon;

grant execute on function postgis_full_version() to authenticated;

grant execute on function postgis_full_version() to service_role;
