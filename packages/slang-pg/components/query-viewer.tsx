...
export const QueryViewer = ( {
  ...
  console.log( "🚀 ~ file: query-viewer.tsx:16 ~ inputValue:", inputValue )





  console.log( "🚀 ~ file: query-viewer.tsx:16 ~ activeQuery:", activeQuery )
  ...
  >()
  console.log( "🚀 ~ file: query-viewer.tsx:19 ~ queryExplanations:", queryExplanations )
  const [loadingExplanation, setLoadingExplanation] = useState( false )

  console.log( "🚀 ~ file: query-viewer.tsx:25 ~ loadingExplanation:", loadingExplanation )

  const [queryExpanded, setQueryExpanded] = useState( activeQuery.length > activeQueryCutoff )

  console.log( "🚀 ~ file: query-viewer.tsx:29 ~ queryExpanded:", queryExpanded )
