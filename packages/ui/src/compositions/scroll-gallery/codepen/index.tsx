export const CodePenScrollGallery = () => {
  return (
    <>
      ...
      <div id="app">
        ...
        <div id="imgGroup">
          <img src="https://picsum.photos/id/100/1000/800" dataX="300" dataY="0" alt="Sepia tone beach" />
          <img src="https://picsum.photos/id/111/1000/800" dataX="200" dataY="250" alt="Vintage car" />
          <img src="https://picsum.photos/id/140/1000/800" dataX="-100" dataY="-150" alt="Bare tree" />
          <img src="https://picsum.photos/id/160/1000/800" dataX="-500" dataY="50" alt="Bottom edge of a phone" />
          <img src="https://picsum.photos/id/180/1000/800" dataX="-60" dataY="-10" alt="Laptop and Moleskine" />
          <img src="https://picsum.photos/id/198/1000/800" dataX="-200" dataY="-200" alt="Grassy hillside" />
          <img src="https://picsum.photos/id/210/1000/800" dataX="100" dataY="-150" alt="Bricks and mortar" />
          <img src="https://picsum.photos/id/220/1000/800" dataX="-300" dataY="50" alt="Foggy train tracks" />
          <img src="https://picsum.photos/id/240/1000/800" dataX="-50" dataY="-200" alt="Stairs to water" />
          <img src="https://picsum.photos/id/260/1000/800" dataX="-120" dataY="60" alt="Snowy mountain forest" />
          <img src="https://picsum.photos/id/280/1000/800" dataX="400" dataY="-100" alt="Rocky jetty" />
          <img src="https://picsum.photos/id/360/1000/800" dataX="-60" dataY="150" alt="Peachy flowers" />
          <img src="https://picsum.photos/id/320/1000/800" dataX="-200" dataY="200" alt="City street" />
          <img src="https://picsum.photos/id/340/1000/800" dataX="300" dataY="-120" alt="Mossy tree" />
        </div>
