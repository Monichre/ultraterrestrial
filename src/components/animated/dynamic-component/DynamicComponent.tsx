...
} from './DynamicComponentCore'

const DynamicAction = () => {
  const { state: blobState, setSize } = useDynamicComponentSize()
  ...
  return (
    <div className=' h-full'>
      <div className='flex flex-col gap-4  h-full'>
        ...
        <DynamicComponentCore id='dynamic-blob'>
          {renderState()}
        </DynamicComponentCore>
      </div>
    </div>
...
export function DynamicComponentDemo() {
  return (
    <DynamicComponentProvider initialSize={'default'}>
      <div>
        <DynamicAction />
      </div>
    </DynamicComponentProvider>
