...
export const GraphNodeCard: React.FC<GraphNodeCardData> = ({
  ...
  return (
    ...
    >
      ...
      <CardHeader className='p-2 relative text-white uppercase font-centimaSans text-lg tracking-wider'>
        {animatedTitle}
      </CardHeader>
      <CardContent className='relative z-20'>
        ...
        <div className='mt-2'>
          <p className='date text-[#78efff] font-centimaSans tracking-wider'>
