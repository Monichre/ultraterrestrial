    ...
    <>
      <div className={`relative w-full my-4 px-2 ${className}`}>
        <input
          ...
          value={value}
          onChange={onChange}
          className='h-8 w-full cursor-default rounded-lg bg-neutral-950 p-3.5 text-slate-100 transition-colors duration-500 placeholder:select-none placeholder:text-neutral-500 placeholder:text-sm placeholder:font-jetbrains focus:border focus:border-[rgb(207_174_255)] focus:outline-none'
        />
        <input
          ref={divRef}
          disabled
