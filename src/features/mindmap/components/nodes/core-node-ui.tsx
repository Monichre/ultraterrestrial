...
export const CoreNodeContent: React.FC<CoreNodeContentProps> = ({ className = '', children }) => {
  return (
    <section
      className={cn(
        'overflow-visible relative rounded-2xl duration-200 border-2 bg-neutral-50 px-4 py-5 shadow-lg shadow-neutral-200/50 dark:bg-neutral-950 dark:shadow-neutral-800/50 border-neutral-200 dark:border-neutral-800',
        className
      )}>
      {children}
    </section>
...
export const CoreNodeContainer = ({ children, id, className }: any) => {
  return (
    <div
      ...
      id={id}>
      <main
        className={`border-2 p-1.5 rounded-3xl duration-200 border-neutral-200 dark:border-neutral-800 bg-neutral-100 dark:bg-neutral-900 group hover:border-indigo-200 dark:hover:border-indigo-800`}>
        {children}
      </main>
      <button
