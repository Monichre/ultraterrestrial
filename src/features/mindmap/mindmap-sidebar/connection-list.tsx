...
export const ModelAvatar = ({ model, className }: any) => {
  ...
  const initials = text ? splitName(text) : 'X'
  return (
    <Avatar className={cn('w-8 h-8 border-[1px] border-white/30', className)}>
      <AvatarImage
...
{
  /* <div className='w-full connection-card relative my-2  rounded-lg border border-white/60 dark:border-border/30 rounded-[calc(var(--radius))] bg-dot-white/[0.2]'>
<div className='flex justify-start w-full h-full p-2 border border-white/20 rounded-[calc(var(--radius)-2px)]'>
  ...
  <p className='cursor-pointer font-jetbrains text-white flex font-light text-sm align-center items-center tracking-wide'>
    <span className='ml-4'>{connection?.name || connection?.title}</span>
  </p>
</div>
</div> */
}
...
export const ConnectionCard = ({ connection }: any) => {
  ...
  return (
    <Card
      className={`entity-card shadow relative rounded-lg border border-white/60 dark:border-border/30 rounded-[calc(var(--radius))] bg-dot-white/[0.2] p-1 z-50`}
    >
    ...
    >
      <div className='flex size-full h-full max-w-lg items-stretch justify-between gap-10'>
        <div className='flex flex-col justify-center'>
          <Circle ref={originalNodeRef} delay={0} inView>
            {/* <ConnectionCard connection={originalNode.data} /> */}
            <ModelAvatar model={originalNode?.data} />
          </Circle>
        </div>
...
export const ConnectionList: React.FC<ConnectionListProps> = ({
  ...
  return (
    <div className='h-[1200px] w-full grow h-max-[1200px]'>
      {/* <div className='connection-list mt-12 h-full w-full'> */}
