...
!(function (r) {
  ...
  function z(e, t, i, n) {
    ...
    return (
      (i = i || q(e))
        ? (r =
            (e = i.getPropertyValue(t.replace(p, '-$1').toLowerCase())) ||
            i.length
              ? e
              : i[t])
  ...
  var o = r.GreenSockGlobals || r,
    ...
    I = document,
    t =
      void 0 !== r ? r : I.defaultView || { getComputedStyle: function () {} },
    p = /([A-Z])/g,
    A = /(?:\r|\n|\t\t)/g,
    L = /(?:\s\s+)/g,
    B = 127462,
    ...
    u =
      ...
      o.SplitText =
        function (e, t) {
          if (('string' == typeof e && (e = u.selector(e)), !n))
            return (
              (r.location.href =
                'http://' + h + i + '?plugin=' + l + '&source=codepen'),
              !1
            )
        ...
        (function (e, t, i, n, r, o, s) {
              ...
              ((f = (h = p[l]).parentNode === e) || j || (R && !k)) &&
                ...
                E &&
                  (((h._isSplit && f) ||
                    ...
                    (u.push(h), (h._x -= y), F(h, e, V) && (h._wordEnd = !0)),
                  'BR' === h.nodeName &&
                    ...
                    ? h._isSplit
                      ...
                      : h.parentNode._isSplit
                        ? ((h._parent = h.parentNode),
                          ...
                          d--)
                        : f ||
                          ((m = !h.nextSibling && F(h.parentNode, e, V)),
          ...
          if (E) {
            ...
            for (
              ...
              for (
                u = E[l],
                  (C = I.createElement(W)).style.cssText =
              ...
              0 === d
                ? (C.innerHTML = '&nbsp;')
                : k || R || (Q(C), P(C, String.fromCharCode(160), ' ')),
