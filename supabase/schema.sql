...
CREATE TYPE "public"."lat_lon" AS ENUM (
    'latitude',
    'longitude'
);

ALTER TYPE "public"."lat_lon" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."event_topic_link" (
    "event_id" bigint NOT NULL,
    "topic_id" bigint NOT NULL
);

ALTER TABLE "public"."event_topic_link" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."personnel_event_link" (
    "personnel_id" bigint NOT NULL,
    "event_id" bigint NOT NULL
);

ALTER TABLE "public"."personnel_event_link" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."personnel_organizations" (
    "personnel_id" integer NOT NULL,
    "organization_id" integer NOT NULL
);

ALTER TABLE "public"."personnel_organizations" OWNER TO "postgres";

CREATE TABLE IF NOT EXISTS "public"."personnel_sighting_link" (
    "personnel_id" bigint NOT NULL,
    "sighting_id" bigint NOT NULL
);

ALTER TABLE "public"."personnel_sighting_link" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."sighting_document_link" (
    "sighting_id" bigint NOT NULL,
    "document_id" bigint NOT NULL
);

ALTER TABLE "public"."sighting_document_link" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."sightings" (
    ...
    "duration_seconds" character varying,
    "duration_hours_min" character varying,
    "comments" "text",
    "date_posted" "date",
    "latitude" numeric,
    "longitude" numeric
...
CREATE SEQUENCE IF NOT EXISTS "public"."testimonies_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE "public"."testimonies_id_seq" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."uforeports" (
    "id" integer NOT NULL,
    "occurance" timestamp without time zone,
    "city" character varying(64) DEFAULT NULL::character varying,
    "citystate" character varying(16) DEFAULT NULL::character varying,
    "country" character(2) DEFAULT NULL::"bpchar",
    "ufoshape" character varying(32) DEFAULT NULL::character varying,
    "dseconds" integer,
    "duration" character varying(64) DEFAULT NULL::character varying,
    "description" character varying(1024) DEFAULT NULL::character varying,
    "reportdate" timestamp without time zone,
    "lat" double precision NOT NULL,
    "lng" double precision NOT NULL,
    "geoloc" "public"."geography"(Point,4326) NOT NULL
);

ALTER TABLE "public"."uforeports" OWNER TO "postgres";

CREATE SEQUENCE IF NOT EXISTS "public"."uforeports_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE "public"."uforeports_id_seq" OWNER TO "postgres";

ALTER SEQUENCE "public"."uforeports_id_seq" OWNED BY "public"."uforeports"."id";

ALTER TABLE ONLY "public"."testimonies" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."testimonies_id_seq"'::"regclass");

ALTER TABLE ONLY "public"."uforeports" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."uforeports_id_seq"'::"regclass");

ALTER TABLE ONLY "public"."documents"
    ADD CONSTRAINT "documents_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."event_topic_link"
    ADD CONSTRAINT "event_topic_link_pkey" PRIMARY KEY ("event_id", "topic_id");
...
ALTER TABLE ONLY "public"."personnel_event_link"
    ADD CONSTRAINT "personnel_event_link_pkey" PRIMARY KEY ("personnel_id", "event_id");

ALTER TABLE ONLY "public"."personnel_organizations"
    ADD CONSTRAINT "personnel_organizations_pkey" PRIMARY KEY ("personnel_id", "organization_id");

ALTER TABLE ONLY "public"."personnel"
    ADD CONSTRAINT "personnel_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."personnel_sighting_link"
    ADD CONSTRAINT "personnel_sighting_link_pkey" PRIMARY KEY ("personnel_id", "sighting_id");

ALTER TABLE ONLY "public"."questions"
    ADD CONSTRAINT "questions_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."sighting_document_link"
    ADD CONSTRAINT "sighting_document_link_pkey" PRIMARY KEY ("sighting_id", "document_id");
...
ALTER TABLE ONLY "public"."uforeports"
    ADD CONSTRAINT "uforeports_pkey" PRIMARY KEY ("id");

CREATE INDEX "idx_citystate" ON "public"."uforeports" USING "btree" ("city", "citystate");

CREATE INDEX "idx_occurance" ON "public"."uforeports" USING "btree" ("occurance");

CREATE INDEX "idx_ufo_geo_spatial" ON "public"."uforeports" USING "gist" ("geoloc");

ALTER TABLE ONLY "public"."documents"
    ADD CONSTRAINT "documents_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id");

ALTER TABLE ONLY "public"."event_topic_link"
    ADD CONSTRAINT "event_topic_link_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id");

ALTER TABLE ONLY "public"."event_topic_link"
    ADD CONSTRAINT "event_topic_link_topic_id_fkey" FOREIGN KEY ("topic_id") REFERENCES "public"."topics"("id");

ALTER TABLE ONLY "public"."events"
    ADD CONSTRAINT "events_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id");

ALTER TABLE ONLY "public"."events"
    ADD CONSTRAINT "events_status_id_fkey" FOREIGN KEY ("status_id") REFERENCES "public"."statuses"("id");

ALTER TABLE ONLY "public"."organizations"
    ADD CONSTRAINT "organizations_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id");

ALTER TABLE ONLY "public"."personnel_event_link"
    ADD CONSTRAINT "personnel_event_link_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id");

ALTER TABLE ONLY "public"."personnel_event_link"
    ADD CONSTRAINT "personnel_event_link_personnel_id_fkey" FOREIGN KEY ("personnel_id") REFERENCES "public"."personnel"("id");

ALTER TABLE ONLY "public"."personnel_organizations"
    ADD CONSTRAINT "personnel_organizations_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;

ALTER TABLE ONLY "public"."personnel_organizations"
    ADD CONSTRAINT "personnel_organizations_personnel_id_fkey" FOREIGN KEY ("personnel_id") REFERENCES "public"."personnel"("id") ON DELETE CASCADE;

ALTER TABLE ONLY "public"."personnel_sighting_link"
    ADD CONSTRAINT "personnel_sighting_link_personnel_id_fkey" FOREIGN KEY ("personnel_id") REFERENCES "public"."personnel"("id");

ALTER TABLE ONLY "public"."personnel_sighting_link"
    ADD CONSTRAINT "personnel_sighting_link_sighting_id_fkey" FOREIGN KEY ("sighting_id") REFERENCES "public"."sightings"("id");

ALTER TABLE ONLY "public"."questions"
    ADD CONSTRAINT "questions_status_id_fkey" FOREIGN KEY ("status_id") REFERENCES "public"."statuses"("id");

ALTER TABLE ONLY "public"."questions"
    ADD CONSTRAINT "questions_topic_id_fkey" FOREIGN KEY ("topic_id") REFERENCES "public"."topics"("id");

ALTER TABLE ONLY "public"."sighting_document_link"
    ADD CONSTRAINT "sighting_document_link_document_id_fkey" FOREIGN KEY ("document_id") REFERENCES "public"."documents"("id");

ALTER TABLE ONLY "public"."sighting_document_link"
    ADD CONSTRAINT "sighting_document_link_sighting_id_fkey" FOREIGN KEY ("sighting_id") REFERENCES "public"."sightings"("id");

ALTER TABLE ONLY "public"."sightings"
    ADD CONSTRAINT "sightings_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id");

ALTER TABLE ONLY "public"."sightings"
    ADD CONSTRAINT "sightings_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id");

ALTER TABLE ONLY "public"."testimonies"
    ADD CONSTRAINT "testimonies_document_id_fkey" FOREIGN KEY ("document_id") REFERENCES "public"."documents"("id");
...
ALTER TABLE ONLY "public"."testimonies"
    ADD CONSTRAINT "testimonies_question_id_fkey" FOREIGN KEY ("question_id") REFERENCES "public"."questions"("id");

ALTER TABLE ONLY "public"."testimonies"
    ADD CONSTRAINT "testimonies_topic_id_fkey" FOREIGN KEY ("topic_id") REFERENCES "public"."topics"("id");

ALTER TABLE ONLY "public"."testimonies"
    ADD CONSTRAINT "testimonies_witness_fkey" FOREIGN KEY ("witness") REFERENCES "public"."personnel"("id");
...
GRANT ALL ON TABLE "public"."event_topic_link" TO "anon";
GRANT ALL ON TABLE "public"."event_topic_link" TO "authenticated";
GRANT ALL ON TABLE "public"."event_topic_link" TO "service_role";
...
GRANT ALL ON TABLE "public"."personnel_event_link" TO "anon";
GRANT ALL ON TABLE "public"."personnel_event_link" TO "authenticated";
GRANT ALL ON TABLE "public"."personnel_event_link" TO "service_role";
...
GRANT ALL ON TABLE "public"."personnel_organizations" TO "anon";
GRANT ALL ON TABLE "public"."personnel_organizations" TO "authenticated";
GRANT ALL ON TABLE "public"."personnel_organizations" TO "service_role";

GRANT ALL ON TABLE "public"."personnel_sighting_link" TO "anon";
GRANT ALL ON TABLE "public"."personnel_sighting_link" TO "authenticated";
GRANT ALL ON TABLE "public"."personnel_sighting_link" TO "service_role";
...
GRANT ALL ON TABLE "public"."sighting_document_link" TO "anon";
GRANT ALL ON TABLE "public"."sighting_document_link" TO "authenticated";
GRANT ALL ON TABLE "public"."sighting_document_link" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."sightings_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."sightings_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."sightings_id_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."testimonies_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."testimonies_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."testimonies_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."uforeports" TO "anon";
GRANT ALL ON TABLE "public"."uforeports" TO "authenticated";
GRANT ALL ON TABLE "public"."uforeports" TO "service_role";

GRANT ALL ON SEQUENCE "public"."uforeports_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."uforeports_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."uforeports_id_seq" TO "service_role";
